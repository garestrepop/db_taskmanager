SPOOL  log_pkmanageruser.txt

ACCEPT schema_name PROMPT 'Ingrese el nombre del esquema: '

--ALTER SESSION SET CURRENT_SCHEMA=&schema_name;

Prompt Package PK_MANAGERUSER;
CREATE OR REPLACE PACKAGE &schema_name..pk_ManagerUser AUTHID DEFINER
IS
/*
    ************************************************************************
...
Prompt Synonym PK_MANAGERUSER;
CREATE OR REPLACE PUBLIC SYNONYM PK_MANAGERUSER FOR &schema_name..PK_MANAGERUSER;

Prompt Package Body PK_MANAGERUSER;
CREATE OR REPLACE PACKAGE BODY &schema_name..pk_ManagerUser
IS
/*
    ************************************************************************
    Intellectual property  Gustavo Alberto Restrepo Peláez
