SPOOL  log_triggertaskaudit.txt

ACCEPT schema_name PROMPT 'Ingrese el nombre del esquema: '

--ALTER SESSION SET CURRENT_SCHEMA=&schema_name;

Prompt Trigger TRG_TASK_AUDIT;
CREATE OR REPLACE TRIGGER &schema_name..TRG_TASK_AUDIT
...
/******************************************************************************
   ...
   ---------  ----------  ---------------  ------------------------------------
   1.0        17/05/2023      &schema_name..      1. Created this trigger.
   ...
   Automatically available Auto Replace Keywords:
      ...
      Username:        &schema_name..(set in TOAD Options, Proc Templates)
